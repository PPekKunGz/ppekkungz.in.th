    ...
    <div className="w-full py-20">
      <div className="flex flex-col justify-center items-center h-full text-white text-4xl" data-aos="zoom-in" data-aos-duration="1000">
        ...
        <Input
            ...
            className={cn(
              "flex h-10 w-full rounded-md border border-input bg-black placeholder:text-white px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50")}
          />
        </div>
      </div>
    </div>
