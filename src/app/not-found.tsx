...
import TriangleAlertIcon from './(root)/_components/assets/svg/TriangleAlertIcon'

export default async function NotFound() {
  return (
    <div className="flex min-h-[800px] flex-col items-center justify-center bg-background px-4 mb-8 py-12 sm:px-6 lg:px-8">
